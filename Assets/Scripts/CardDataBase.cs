    ...
    void InitializeCardList()
      {
        ...
        cardList.Add(new Card(2, "Sir Bladefury", 6, "none", "Golden", Resources.Load <Sprite>("3"), "Melee", 1));
        cardList.Add(new Card(3, "Siege Colossus", 4, "none", "Silver", Resources.Load <Sprite>("4"), "Siege", 1));
        cardList.Add(new Card(4, "Knight Ironclaver", 6, "none", "Silver", Resources.Load <Sprite>("5"), "Melee", 1));
        cardList.Add(new Card(5, "Sir Bananathor", 4, "none", "Silver", Resources.Load <Sprite>("6"), "Clima", 1));
        ...
        cardList.Add(new Card(9, "Knight Thunderclash", 7, "none", "Leader", Resources.Load <Sprite>("10"), "Melee", 1));
        cardList.Add(new Card(10, "Lord Shadowblade", 6, "none", "Golden", Resources.Load <Sprite>("11"), "Melee", 1));
        cardList.Add(new Card(11, "MoonBlade", 5, "none", "Golden", Resources.Load <Sprite>("12"), "Melee", 1));
        cardList.Add(new Card(12, "Swiftstriker", 5, "none", "Golden", Resources.Load <Sprite>("13"), "Range", 1));

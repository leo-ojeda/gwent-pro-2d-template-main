...
public class CardDatabase : MonoBehaviour
{
    ...
    void InitializeCardList()
    {
        ...
        var damageEffect = new EffectActivation(EffectLibrary.Damage(1), new Selector("Field", false, ""));
        ...
        cardList.Add(new Card("Guerrero", 5, "Golden", new string[] { "Melee" }, "Torment", new List<EffectActivation> { damageEffect }, " "));
        cardList.Add(new Card("Espadachin", 6, "Golden", new string[] { "Melee" }, "Torment", new List<EffectActivation> { damageEffect }, " "));
        cardList.Add(new Card("Colosal", 4, "Silver", new string[] { "Siege" }, "Torment", new List<EffectActivation> { damageEffect }, ""));
        cardList.Add(new Card("Caballero de Hacha", 6, "Silver", new string[] { "Melee" }, "Torment", new List<EffectActivation> { damageEffect }, " "));
        ...
        cardList.Add(new Card("Espada Oscura", 6, "Golden", new string[] { "Melee" }, "Torment", new List<EffectActivation>(), ""));
        ...
        //cardList.Add(new Card( "Ciudad del Abismo", 0, "Silver",  "Increase",  "Torment",new List<EffectActivation>()," "));
        //cardList.Add(new Card( "Banana Del Caos", 0,  "Silver", "Increase",  "Torment"));
        //cardList.Add(new Card( "Sacerdote", 0,  "Silver",  "Clima",  "Torment"));
        //cardList.Add(new Card( "Ciudad Nublada", 0,  "Silver",  "Clima",  "Torment"));

...
public class CardDatabase : MonoBehaviour
{
    ...
    void InitializeCardList()
    {
        ...
        cardList.Add(new Card("Caballero de Hacha", 6 , "Silver",  new string[] { "Melee" }, "Torment",new List<EffectActivation>()," "));
        ...
        cardList.Add(new Card("Defensor de Hechizo",0,  "Silver",  new string[] { "Ranged" }, "Torment",new List<EffectActivation>()," "));
